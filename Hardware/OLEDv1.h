...
/*
	...
	// 排线顺序引脚 灰紫蓝绿
	OLED2.D1_GPIO	= GPIOB;	OLED2.D1_Pin	= GPIO_Pin_12;
	OLED2.D0_GPIO	= GPIOB;	OLED2.D0_Pin	= GPIO_Pin_13;
	OLED2.DC_GPIO	= GPIOB;	OLED2.DC_Pin	= GPIO_Pin_14;
	OLED2.CS_GPIO	= GPIOB;	OLED2.CS_Pin	= GPIO_Pin_15;
	...
	OLED3.CS_GPIO	= GPIOA;	OLED3.CS_Pin	= GPIO_Pin_11;
	OLED3.DC_GPIO	= GPIOA;	OLED3.DC_Pin	= GPIO_Pin_10;
	OLED3.D0_GPIO	= GPIOA;	OLED3.D0_Pin	= GPIO_Pin_9;
	OLED3.D1_GPIO	= GPIOA;	OLED3.D1_Pin	= GPIO_Pin_8;
	OLED_Init(&OLED3);
