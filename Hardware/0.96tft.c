...
sbit bl        =P3^5;//接模块BL引脚，背光可以采用IO控制或者PWM控制，也可以直接接到高电平常亮
sbit scl       =P3^0;//接模块CLK引脚,接裸屏Pin9_SCL
sbit sda       =P3^1;//接模块DIN/MOSI引脚，接裸屏Pin8_SDA
sbit rs        =P3^3;//接模块D/C引脚，接裸屏Pin7_A0
sbit cs        =P3^4;//接模块CE引脚，接裸屏Pin12_CS
sbit reset     =P3^2;//接模块RST引脚，接裸屏Pin6_RES
//---------------------------End of液晶屏接线---------------------------------//
